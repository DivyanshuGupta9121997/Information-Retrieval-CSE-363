...
def store_paths():
	d={}
	i=0
	for root,dirs,files in os.walk('/home/dg/Downloads/Assignment2/dataset'):
		if not dirs:
			for f in files:
...
#with open("postingdict.pkl","wb") as f:
#	pickle.dump(postingdict,f,pickle.HIGHEST_PROTOCOL)

#with open("postingdict.pkl","rb") as f:
#	k=pickle.load(f)
#	print(k)
#with open("docfreq.pkl","wb") as f:
#	pickle.dump(doc_freq,f,pickle.HIGHEST_PROTOCOL)

#with open("docfreq.pkl","rb") as f:
#	k=pickle.load(f)
#	print(k)
